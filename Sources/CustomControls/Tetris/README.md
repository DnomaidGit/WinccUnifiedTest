***
# Custom Web Controls Tetris Installation Guide
***
...
4. **Add Control File**: Store the custom web control **🔵 {4E4FE6DA-82F7-4B2A-9C67-4432F6BEE3DE}.zip** file in the `CustomControls` folder.
